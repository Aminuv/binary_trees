 ...
 * @_parent: Pointer to the _parent node
...
binary_tree_t *binary_tree_node(binary_tree_t *_parent, int value);
binary_tree_t *binary_tree_insert_left(binary_tree_t *_parent, int value);
binary_tree_t *binary_tree_insert_right(binary_tree_t *_parent, int value);
